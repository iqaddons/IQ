...
public class FeatureModule implements LifecycleComponent {
    ...
    public void start() {
        ...
        features.register(
                ...
                new NoPreAlertFeature(), new SecondSupplyAlertFeature(), new CustomSupplyMessageFeature(),
                ...
                new TeamHighlightFeature(), new TeamHighlightFreshColorFeature(), new KuudraPhaseAlertFeature(), new DangerAlertFeature(),
