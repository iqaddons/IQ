...
import net.iqaddons.mod.mixin.accessor.HudAccessor;
...
public class SupplyGiantHitboxAlertFeature extends KuudraFeature {
    ...
    private void clearSubtitle() {
        if (activeSubtitle != null && mc.gui != null) {
            Component current = ((HudAccessor) mc.gui.hud).iq$getSubtitle();
            // Do not erase another feature's subtitle if it replaced ours.
    ...
    private void updateDetection() {
        ...
        if (collectingSupply) {
            ...
            // Refresh while collecting and overlapping; remove immediately on exit.
