...
public class KuudraGeneralConfig {
    ...
    @Comment(PACE_SPLITS_BENCHMARKS_DESCRIPTION)
    ...
    @Comment("Display a widget that tracks all kuudra chest until the limit of 60/60")
    public static boolean chestCounterTracker = true;

    @ConfigEntry(
            id = "chestCounterConfig",
            translation = "Chest Counter Config"
    )
    @Comment("Configure visibility and party announcements for the Chest Counter")
    public static final ChestCounterConfig chestCounterConfig = new ChestCounterConfig();
    ...
    public static class CustomSplitsBenchmarks {
        ...
        public static double total() {
            return supplies + build + eaten + stun + dps + skip + boss;
        }

        public static String sectionDescription() {
            return String.format(Locale.US, "%s Total benchmark: %.2fs.",
                    PACE_SPLITS_BENCHMARKS_DESCRIPTION, total());
        }
    }
    ...
    @ConfigObject
    public static class ChestCounterConfig {
        @ConfigEntry(id = "chestCounterVisibility", translation = "Chest Counter Visibility")
        @ConfigOption.Select
        @Comment("Control when the chest counter is visible")
        public static ChestCounterVisibility chestCounterVisibility = ChestCounterVisibility.KUUDRA_AREAS;

        @ConfigEntry(id = "chestCounterPartyAnnouncements", translation = "Chest Counter Party Announcements")
    ...
    public enum ChestCounterVisibility {
        KUUDRA_AREAS, ALWAYS
    }
