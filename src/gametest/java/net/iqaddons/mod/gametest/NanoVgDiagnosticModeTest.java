...
/** Deterministic checks for the Prism-controlled NanoVG diagnostic modes. */
public final class NanoVgDiagnosticModeTest {
    public static void main(String[] args) {
        ...
        System.out.println("PASS: NanoVG diagnostic mode regressions");
    }
    ...
    private static void offBlocksAllNanoVgLifecycleAndDrawingDecisions() {
        ...
        check(calls.get() == 4, "full must execute every NanoVG lifecycle and drawing callback");
    }
